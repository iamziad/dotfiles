...
#+begin_src emacs-lisp
(use-package gruvbox-material-theme
    :straight (gruvbox-material-theme :local-repo "~/gruvbox-material-emacs"
    				                  :type git
    				                  :files ("*.el"))
    :config
    (setq gruvbox-material-variant             'classic
          gruvbox-material-contrast            'medium
          gruvbox-material-modeline            'material
          gruvbox-material-org                 'material
          gruvbox-material-diff-hl-style       'signs
          gruvbox-material-org-scale-headings   nil)
